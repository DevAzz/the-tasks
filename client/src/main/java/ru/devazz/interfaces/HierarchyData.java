...
/**
 * Used to mark an object as hierarchical data. This object can then be used as
 * data source for an hierarchical control, like the
 * {@link javafx.scene.control.TreeView}.
 */
